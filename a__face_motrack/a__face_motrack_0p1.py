...
class AFaceMoTrack0p1_Panel_Tracking(bpy.types.Panel):
...
class AFaceMoTrack0p1_Panel_DataAction(bpy.types.Panel):
...
def register():    
    bpy.utils.register_class(AFaceMoTrack0p1_Panel_Tracking)
    ...
    bpy.utils.register_class(AFaceMoTrack0p1_Panel_DataAction)
...
def unregister():
    bpy.utils.unregister_class(AFaceMoTrack0p1_Panel_Tracking)
    ...
    bpy.utils.unregister_class(AFaceMoTrack0p1_Panel_DataAction)
